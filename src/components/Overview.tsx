    ...
    <section id="overview" className="py-16 md:py-24 px-6 relative z-10 bg-gray-50 dark:bg-transparent dark:border-t dark:border-white/[0.05]">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20 lg:mb-24">
          ...
          {/* Right: Graphic */}
          <div className="bg-[#151515] dark:bg-[#151515] rounded-3xl dark:rounded-[2.5rem] min-h-[400px] flex justify-center items-center relative overflow-hidden border border-gray-200 dark:border-white/[0.05] group shadow-sm dark:shadow-2xl transition-all duration-300 transform hover:shadow-xl dark:hover:shadow-[0_0_40px_rgba(34,211,238,0.15)] w-full">
