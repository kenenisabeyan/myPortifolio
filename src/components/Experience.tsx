              ...
              <RevealOnScroll key={idx}>
                <div className="relative flex flex-col md:flex-row items-center md:items-start w-full z-10">
                  ...
                  <div className="absolute left-0 md:left-1/2 transform translate-x-[20px] md:-translate-x-1/2 flex items-center justify-center z-20 top-8 md:top-1/2 md:-translate-y-1/2">
                    <div className={`w-3.5 h-3.5 rounded-full ${exp.iconColor} border-2 border-white dark:border-[#030610] shadow-[0_0_10px_rgba(0,0,0,0.1)] dark:shadow-[0_0_15px_rgba(34,211,238,0.4)]`}></div>
                  </div>
