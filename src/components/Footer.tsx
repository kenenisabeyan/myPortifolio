    ...
    <footer className="py-8 px-6 relative z-10 border-t border-gray-200 dark:border-white/[0.05] bg-gray-50 dark:bg-transparent">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex items-center gap-8">
          <a href="#" className="text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:hover:text-cyan-400 transition-colors duration-300 transform hover:-translate-y-1 hover:scale-110">
            <span className="sr-only">GitHub</span>
            <FaGithub className="text-[1.3rem]" />
          </a>
          <a href="#" className="text-gray-400 dark:text-gray-500 hover:text-blue-600 dark:hover:text-cyan-400 transition-colors duration-300 transform hover:-translate-y-1 hover:scale-110">
            <span className="sr-only">LinkedIn</span>
            <FaLinkedin className="text-[1.3rem]" />
          </a>
          <a href="#" className="text-gray-400 dark:text-gray-500 hover:text-blue-400 dark:hover:text-cyan-400 transition-colors duration-300 transform hover:-translate-y-1 hover:scale-110">
